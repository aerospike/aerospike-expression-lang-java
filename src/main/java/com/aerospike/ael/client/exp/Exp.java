 ...
 * the License.
 */
package com.aerospike.ael.client.exp;

import com.aerospike.ael.client.command.ParticleType;
import com.aerospike.ael.client.query.RegexFlag;
import com.aerospike.ael.client.util.Packer;
...
public abstract class Exp {
     ...
     * The failure can be ignored with {@link ExpWriteFlags#EVAL_NO_FAIL}
     * or {@link ExpReadFlags#EVAL_NO_FAIL}.
     * Requires server version 5.6.0+.
     *
     * <pre>{@code
